...
ADMINS = ( 'Phebe Joshua', 'feba.j7@gmail.com'
)
...
DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'Phebe Joshua')
DEFAULT_FROM_EMAIL = get_from_env('DEFAULT_FROM_EMAIL', 'feba.j7@gmail.com')
#DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'Phebe Joshua)
...
# election stuff
SITE_TITLE = get_from_env('SITE_TITLE', 'Online-Voting')
...
WELCOME_MESSAGE = get_from_env('WELCOME_MESSAGE', "Welcome to the Online - Voting Website.")

HELP_EMAIL_ADDRESS = get_from_env('HELP_EMAIL_ADDRESS', 'help@online-voting.org')
...
TWITTER_API_KEY = ''
TWITTER_API_SECRET = ''
TWITTER_USER_TO_FOLLOW = 'onlinevoting'
...
EMAIL_HOST_USER = get_from_env('EMAIL_HOST_USER', 'pjlabcollege@gmail.com')
EMAIL_HOST_PASSWORD = get_from_env('EMAIL_HOST_PASSWORD', '1234@1234')
EMAIL_USE_TLS = True
